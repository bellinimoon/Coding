...
public class Imperial_II extends StarDestroyer implements Maneuver, Docks, Launchers {
	public Imperial_II(String shpNumber, String shpName) {
		super(shpNumber, shpName);
		setShpCrew(12000);
		setShpClass("Imperial_II");
		Hull hull = new Hull("H1", "Imperial_II");
		Engine engine = new Engine("E1", "Imperial_II");
		Deck deck = new Deck("D1", "Imperial_II");
